...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Aide à domicile à Saint-Outrille - Nathalie Kucor</title>
        <meta name="description" content="Aide-soignante diplômée d'État à Saint-Outrille, Nathalie Kucor propose un accompagnement à domicile humain, personnalisé et de confiance. Découvrez ses services, ses valeurs et ses témoignages." />
        <meta name="keywords" content="aide à domicile, Saint-Outrille, accompagnement, aide-soignante, services à la personne, bienveillance, confiance, intervention, soins, autonomie" />
        <meta property="og:title" content="Aide à domicile à Saint-Outrille - Nathalie Kucor" />
        <meta property="og:description" content="Aide-soignante diplômée d'État à Saint-Outrille, accompagnement à domicile humain et personnalisé. Contactez Nathalie Kucor pour une intervention adaptée à vos besoins." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://aide-a-la-personne.vercel.app/" />
      ...
      <div className="space-y-16">
        {/* Hero Section */}
        <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden animate-fade-in-up">
        ...
        {/* Mission Section */}
        <section className="py-16 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  basée on l'écoute, la bienveillance et le respect de votre rythme de vie.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Features Section */}
        <section className="py-16 bg-gray-50 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow animate-fade-in-up" style={{ animationDelay: `${0.5 + index * 0.1}s` }}>
        ...
        {/* Experience Section */}
        <section className="py-16 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
        ...
        {/* CTA Section */}
        <section className="py-16 bg-primary text-white animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <Button asChild size="lg" variant="secondary" className="text-lg px-8 transition-transform duration-300 hover:scale-105">
